...
(() => {
    'use strict'
    const saveAs = saveAs || function (e) {
        'use strict'
    ...
    // Start everything
    window.addEventListener('image-label-mounted', () => {
        listenCanvas()
        listenCanvasMouse()
        listenImageLoad()
        listenImageSelect()
    ...
    const listenCanvas = () => {
        canvas = new Canvas('canvas', document.getElementById('right').clientWidth, document.getElementById('right').clientHeight)
