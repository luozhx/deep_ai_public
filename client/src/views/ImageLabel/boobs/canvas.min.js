...
(function (window) {
    !function (e) {
        'use strict'
        var n, t = 0, a = ['moz', 'webkit', 'o', 'ms']
        for (n = 0; n < a.length && !e.requestAnimationFrame; n += 1) e.requestAnimationFrame = e[a[n] + 'RequestAnimationFrame'], e.cancelAnimationFrame = e[a[n] + 'CancelAnimationFrame'] || e[a[n] + 'CancelRequestAnimationFrame']
        e.cancelAnimationFrame || (e.requestAnimationFrame ? (a = e.requestAnimationFrame, t = {}, e.requestAnimationFrame = function (e) {
            var i = n
            return n += 1, t[i] = e, a(function (e) {
            ...
            var a = (new Date).getTime(), i = Math.max(t + 16, a)
    ...
    window.CanvasRenderingContext2D && (CanvasRenderingContext2D.prototype.reset = function () {
    ...
    Canvas.Element = class Element {
        ...
        animate () {
            ...
            switch (type) {
                case 'move':
                    this.animation = { type: type, from: { x: this.x, y: this.y }, to: { x: args.x, y: args.y } }
                    break
                case 'lineLength':
                    this.animation = {
                        type: type,
